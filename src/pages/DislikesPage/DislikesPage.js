  ...
  return (
    <div className={css.dislikes}>
      ...
      <div className={css.dislikes__wrapper}>
        ...
        <div className={css.dislikes__navigationBlock}>
          <div className={css.dislikes__backLinkBlock}>
            <Link to={'/'} className={css.dislikes__backLink}>
          ...
          <div className={css.dislikes__nameOfPage}>
            DISLIKES 
          </div>
