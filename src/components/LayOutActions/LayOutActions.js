...
import css from './LayOutActions.module.css';

const LayOutActions = () => {
  return (
    <div className={css.layOutActions}>
      <div className={css.layOutActions__wrapper}>
        <form className={css.actions__form}>
        ...
        <div className={css.actions__item}>
          <NavLink className={css.actions__navLnk} to="/favourites">
        ...
        <div className={css.actions__item}>
          <NavLink className={css.actions__navLnk + ' ' + css.actions__navLink_heart} to="/likes">
        ...
        <div className={css.actions__item}>
          <NavLink className={css.actions__navLnk} to="/dislikes">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
