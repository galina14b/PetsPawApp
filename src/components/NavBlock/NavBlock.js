...
const NavBlock = () => {
  ...
  function handleSearchInput(event) {
    ...
    navigate(`/breeds/search/${value}`, { replace: true });
  }
    ...
    <div className={css.layOutActions}>
      <div className={css.layOutActions__wrapper}>
        ...
        <div className={css.actions__item}>
          <NavLink className={css.actions__navLnk} to="/breeds/likes">
        ...
        <div className={css.actions__item}>
          <NavLink className={css.actions__navLnk + ' ' + css.actions__navLink_heart} to="/breeds/favourite">
        ...
        <div className={css.actions__item}>
          <NavLink className={css.actions__navLnk} to="/breeds/dislikes">
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
