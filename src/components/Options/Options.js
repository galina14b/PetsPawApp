...
export const Options = ({voteLike, voteDislike, addToFavourites}) => {
  return (
    <>
      {/* Like vote option */}
      <div className={css.options__item + ' ' + css.like} onClick={voteLike}>
      ...
      {/* Favourite add option */}
      <div className={css.options__item + ' ' + css.favourite} onClick={addToFavourites}>
      ...
      {/* Dislike vote option */}
      <div className={css.options__item + ' ' + css.dislike} onClick={voteDislike}>
        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
